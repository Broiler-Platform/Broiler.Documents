...
**Updated:** 2026-09-03 (DOCX-IP-006 and the label set approved; the other rows undecided)
...
**One row is decided:** DOCX-IP-006 and its label set, approved by the project
reviewer on 2026-09-03. Every other row is `Pending` or a recorded inspection
finding awaiting sign-off, and the approval authority above is the only one who
can change that. In particular **the patent rows are undecided**, so nothing here
is cleared and the approval of a naming rule says nothing about them.
